...
- 扫描时间：`2026-07-04T09:00:04`
- 扫描根目录：`C:\Users\USER\Downloads\Telegram Desktop`
- 命中文件总数：`3902`
- 血缘分级：`strong=11`，`medium=430`，`weak=3461`
- 内容扫描口径：文件 <= 12MB，仅读前 256KB
- ZIP 结构相似组：`47`，保留最新版：`96`，旧版跳过：`134`
- ZIP 解压去重（SHA-256）：unique=`797`，duplicate=`993`，budget_exhausted=`True`
...
- `C:\Users\USER\Downloads\Telegram Desktop\ace_runtime\00_ROOT`
  - structure_score=5, tokens=protocol, protocols, runtime, keyword_hits=30, pair_hits=5
...
- `C:\Users\USER\Downloads\Telegram Desktop\ace_runtime\09_KNOWLEDGE`
  - structure_score=4, tokens=chip, guardian, lexicon, memory, persona, runtime, shadow, keyword_hits=540, pair_hits=65
- `C:\Users\USER\Downloads\Telegram Desktop\ace_runtime\08_ARCHAEOLOGY`
  - structure_score=4, tokens=archive, aum, chip, lexicon, memory, protocol, runtime, shadow, keyword_hits=429, pair_hits=81
- `C:\Users\USER\Downloads\Telegram Desktop\ace_runtime`
  - structure_score=4, tokens=lexicon, memory, runtime, keyword_hits=170, pair_hits=41
...
- `C:\Users\USER\Downloads\Telegram Desktop\ACE_CIVILIZATION_BACKUP\shard_2_protocols`
  - structure_score=4, tokens=memory, protocol, protocols, keyword_hits=56, pair_hits=5
...
- `C:\Users\USER\Downloads\Telegram Desktop\ace_runtime\06_RUNTIME\ace\data\memory\lexicon.json`
  - mtime=2026-07-03T15:35:06, size=771328, lineage=medium(52), ref_name_hits=0
